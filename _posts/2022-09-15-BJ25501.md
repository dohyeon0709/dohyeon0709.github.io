...
'''
printf("%d %d",isPalindrome(s),count());    // 틀렸다고 나온 코드
'''
'''
printf("%d ",isPalindrome(s));    // 맞았다고 나온 코드
printf("%d\n",count());
'''
이것처럼 출력할 때 한꺼번에 하면 파라미터는 뒤에서부터 처리될 수도 있고 앞에서부터 처리될 수도 있다고 한다. <br>
